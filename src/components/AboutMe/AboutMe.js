      ...
      <div className="about-me__container">
        ...
        <div className="about-me__text-content">
          ...
          <p className="about-me__bio">Я родился и живу в Саратове, закончил факультет экономики СГУ. У меня есть жена
            и&nbsp;дочь. Я люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. С 2015 года работал в компании «СКБ Контур». После того, как прошёл курс по <span className="about-me__bio-nowrap">веб-разработке</span>, начал заниматься <span className="about-me__bio-nowrap">фриланс-заказами</span> и ушёл с постоянной работы.</p>
